    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.communication_btn:
                type_pic.setImageResource(R.drawable.communication_png);
                type_word.setText("通讯");
                break;
            case R.id.daily_btn:
                type_pic.setImageResource(R.drawable.daily);
                type_word.setText("日用品");
                break;
            case R.id.live_btn:
                type_pic.setImageResource(R.drawable.live_png);
                type_word.setText("生活");
                break;
            case R.id.food_btn:
                type_pic.setImageResource(R.drawable.food_png);
                type_word.setText("食品");
                break;
            case R.id.friendship_btn:
                type_pic.setImageResource(R.drawable.friendship_png);
                type_word.setText("人情");
                break;
            case R.id.house_btn:
                type_pic.setImageResource(R.drawable.house_png);
                type_word.setText("房租");
                break;
            case R.id.medicine_btn:
                type_pic.setImageResource(R.drawable.medicine_png);
                type_word.setText("医药");
                break;
            case R.id.traffic_btn:
                type_pic.setImageResource(R.drawable.traffic_png);
